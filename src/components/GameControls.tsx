        ...
        <div className="grid grid-cols-2 gap-2">
          {status === 'not-started' && (
            <button
              ...
              disabled={!hasTeams}
              className={cn(
                'col-span-2 rounded-lg px-4 py-3 font-outfit text-xs font-bold uppercase tracking-wider transition-all',
                hasTeams
                  ? 'btn-emerald'
              ...
              <div className="space-y-1.5">
                {state.teams
                  ...
                  .map((team) => (
                    <p
                      key={team.id}
                      className="rounded-lg border border-[var(--crimson)]/20 bg-[var(--crimson-glow)] px-3 py-2 font-outfit text-[11px] font-medium text-[var(--crimson)]"
                    >
